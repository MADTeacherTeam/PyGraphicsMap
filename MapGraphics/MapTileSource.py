...
class MapTileSource(QtCore.QObject):
    ...
    def _getTileExpirationTime(self,cacheID):
        ...
        if cacheID in self.__cacheExpirations:
            ...
            QtCore.qWarning("Tile"+cacheID+"has unknown expire time. Resetting to default of"+DEFAULT_CACHE_DAYS + "days.")
    ...
    def __getDiskCacheDirectory(self,x,y,z):
        pathString=QtCore.QDir.homePath()+"/"+ MAPGRAPHICS_CACHE_FOLDER_NAME + "/" + self.name() + "/" +  str(z) + "/" + str(x)
